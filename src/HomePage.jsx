  ...
  },
  {
    ...
    children: [
      { title: "About Financial Affairs", link: "../../../about/index.html" },
      {
        ...
        link: "../../../about/organizational-charts.html",
      },
      { title: "Leadership Team", link: "../../../about/leadership-team.html" },
      {
        title: "Office of Financial Affairs",
        link: "../../../about/office-of-financial-affairs.html",
      },
      {
        title: "Customer Service Standards",
        link: "../../../about/customer-service-standards.html",
      },
      { title: "Fiscal Year-End", link: "../../../about/fiscal-year-end.html" },
      {
        title: "Annual Business Service Centers Training",
        link: "../../../about/annual-bsc-training.html",
      },
      {
        title: "Decision-Making Framework",
        link: "../../../about/decision-making-framework.html",
      },
    ],
  },
  {
    ...
    children: [
      { title: "Accounting Services", link: "../../accounting/index.html" },
      {
        ...
        link: "https://www.utsa.edu/budget/",
        target: "_blank",
      },
      {
        title: "Business Contracts Office",
        link: "https://www.utsa.edu/bco/",
        target: "_blank",
      },
      {
        title: "Credit Card Administration",
        link: "../../credit-card-administration/index.html",
      },
      {
        title: "Distribution Services",
        link: "../../distribution-services/index.html",
      },
      {
        title: "Disbursements & Travel Services",
        link: "../../disbursements-travel/index.html",
      },
      {
        title: "Financial Services",
        link: "../../financial-services/index.html",
      },
      { title: "Fiscal Services", link: "../../fiscal-services/index.html" },
      {
        title: "Grants & Contracts Financial Services",
        link: "../../grants-contracts/index.html",
      },
      { title: "Inventory", link: "../../inventory/index.html" },
      {
        title: "Payroll Management Services",
        link: "../../payroll/index.html",
      },
    ...
    children: [
      {
        ...
        link: "../../../training/accounting-services.html",
      },
      { title: "Budget", link: "../../../training/budget.html" },
      {
        title: "Credit Card Administration",
        link: "../../../training/credit-card-administration.html",
      },
      {
        title: "Disbursements & Travel",
        link: "../../../training/disbursements-travel.html",
      },
      {
        title: "Financial Services",
        link: "../../../training/financial-services.html",
      },
      ...
      {
        title: "Which Training Is for Me?",
        link: "../../../training/which-training-for-me.html",
      },
    ],
  },
  {
    ...
    children: [
      { title: "Forms", link: "../../../resources/forms/index.html" },
      {
        ...
        link: "../../../resources/financial-guidelines/index.html",
      },
      {
        title: "Financial Area Representatives",
        link: "../../../resources/far/index.html",
      },
      {
        title: "Financial Reports & Presentations",
        link: "../../../resources/financial-reports/index.html",
      },
    ],
  },
];
...
const MainNavigation = () => (
  <ul
    className="pl-1 pl-md-2 pl-lg-4 navbar-nav d-block ut"
    id="departmentalPageNav"
  >
...
const GroupContractsTable = () => (
  <div className="container pt-2">
    <p>
      A Group Purchasing Organization (GPO) procures contracts on behalf of the
      members it serves. The{" "}
      <a
    ...
    <p>
      If you have any questions about this tool, or if you would like additional
      information on any of the contracts listed below please email{" "}
    ...
    >
      ...
      >
        ...
        <tbody>
          ...
          {data.map((item, index) => (
            <tr className={`${index % 2 === 0 ? "odd" : "even"}`} key={`row-${index}`}>
      ...
      <div
        ...
        aria-live="polite"
      >
        Showing 1 to 10 of 10,200 entries
      </div>
      <div
  ...
  return (
    <section className="page-content" id="main-content">
      ...
      <section
        className="container"
        id="site-navigation"
        data-gtm-vis-first-on-screen12328767_185="1216260"
        data-gtm-vis-total-visible-time12328767_185="100"
        data-gtm-vis-has-fired12328767_185="1"
      >
        <div className="containerWrapper">
